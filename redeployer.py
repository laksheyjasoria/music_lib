...
from config import Config  # Make sure you set your GitHub repo, token, etc. in config
...
class Redeployer:
    def __init__(self):
        ...
        self.workflow_file = Config.GITHUB_WORKFLOW_FILENAME  # e.g. deploy.yml
        self.branch = Config.GITHUB_BRANCH  # e.g. "main"

    def trigger(self):
        """
        Triggers a GitHub Actions workflow_dispatch event to redeploy the app.
        Returns:
        ...
        try:
            ...
            logger.info("GitHub redeployment triggered successfully.")
            return {"status": "ok", "message": "Redeployment triggered."}
